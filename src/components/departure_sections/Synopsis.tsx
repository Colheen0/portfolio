        ...
        <div className="grid gap-16">
          ...
          <ScrollReveal delay={0.4}>
            <div className="columns-1 md:columns-2 gap-12 space-y-8 text-slate-400 leading-relaxed text-lg font-light">
              ...
              <p>
                Ce projet c'est mon projet de coeur, j'y ai mis tout ce que j'ai : mon imagination, ma passion, mon espoir, tout. C'est une histoire que j'ai écrite d'abord pour moi en y mettant tout ce que j'aime dans la fiction, mais c'est aussi une histoire que j'ai envie de partager avec le plus grand nombre pour faire réfléchir les gens, les faire rêver et revenir à des choses simples.
              </p>

...
const VideoVignette = ({ title, thumbnail, videoUrl }: VideoVignetteProps) => (
  <a 
    href={videoUrl} 
    target="_blank" 
    rel="noopener noreferrer"
    className="group relative block overflow-hidden rounded-2xl bg-slate-100 aspect-video shadow-sm hover:shadow-xl transition-all border border-slate-200 min-w-75 md:min-w-100 snap-center"
  >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-slate-400 text-sm font-medium">Stage • 2024</span>
          </div>
